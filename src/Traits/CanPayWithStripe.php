...
use Lakshmaji\Plans\Helpers\StripeHelper;
    ...
    public function chargeForLastDueSubscription($callback = null)
    {
        ...
        if (! is_callable($callback)) {
            try {
                ...
                event(new \Lakshmaji\Plans\Events\Stripe\DueSubscriptionChargeSuccess($this, $lastDueSubscription, $stripeCharge));
            } catch (\Exception $exception) {
                event(new \Lakshmaji\Plans\Events\Stripe\DueSubscriptionChargeFailed($this, $lastDueSubscription, $exception));
