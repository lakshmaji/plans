...
namespace Lakshmaji\Plans\Models;
...
class PlanSubscriptionModel extends Model
{
    ...
    public function consumeFeature(string $featureCode, float $amount)
    {
        ...
        event(new \Lakshmaji\Plans\Events\FeatureConsumed($this, $feature, $amount, $remaining));
    ...
    public function unconsumeFeature(string $featureCode, float $amount)
    {
        ...
        event(new \Lakshmaji\Plans\Events\FeatureUnconsumed($this, $feature, $amount, $remaining));
