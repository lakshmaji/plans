...
namespace Lakshmaji\Plans\Test;

use Stripe\Stripe;
use Stripe\Token as StripeToken;
use Lakshmaji\Plans\Models\PlanModel;
use Lakshmaji\Plans\Test\Models\User;
use Lakshmaji\Plans\Models\PlanFeatureModel;
use Orchestra\Testbench\TestCase as Orchestra;
use Lakshmaji\Plans\Models\StripeCustomerModel;
use Lakshmaji\Plans\Models\PlanSubscriptionModel;
use Lakshmaji\Plans\Models\PlanSubscriptionUsageModel;
...
abstract class TestCase extends Orchestra
{
    ...
    {
        return [
            \Lakshmaji\Plans\PlansServiceProvider::class,
        ];
    }
