...
class PlanTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->user = factory(\Lakshmaji\Plans\Test\Models\User::class)->create();
        $this->plan = factory(\Lakshmaji\Plans\Models\PlanModel::class)->create();
        $this->newPlan = factory(\Lakshmaji\Plans\Models\PlanModel::class)->create();
    }
